...
void deNoising::addNoiseSoltPepperMono(Mat& src, Mat& dest, double per)
{
	cv::RNG rng;
...
void deNoising::addNoiseMono(Mat& src, Mat& dest, double sigma)
{
	Mat s;
...
void deNoising::addNoise(Mat&src, Mat& dest, double sigma, double sprate)
{
	if (src.channels() == 1)
	{
...
////////////////////////////////////////////////////////////////////////////////  
//main implementaion  
void deNoising::nonlocalMeansFilter(Mat& src, Mat& dest, int templeteWindowSize, int searchWindowSize, double h, double sigma )
{
...
****************nonlocalMeansFilter*******************
src:input Image
noise_sigma:paramter of removing noise
*/
Mat deNoising::denoisingMain(Mat src, double noise_sigma)
{
	Mat dst;
	clock_t startTime = clock();
	nonlocalMeansFilter(src, dst, 3, 5, noise_sigma, noise_sigma);
	cout << "nonlocalMeansFilter: " << clock() - startTime << "ms" << endl;
	return dst;
}